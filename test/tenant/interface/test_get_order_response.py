...
from swagger_client.tenant.models.get_order_response import GetOrderResponse  # noqa: E501
...
class TestGetOrderResponse:
    ...
    def testGetOrderResponse(self):
        ...
        # model = swagger_client.tenant.models.get_order_response.GetOrderResponse()  # noqa: E501
        pass
