...
# 申请项目通过——获取项目方未对接的交易所列表——申请接入交易所——交易所同意
...
class TestProjectCase5(object):

    @pytest.mark.order1
    def test_applications5(self):
        faker = Faker()
        ...
        short_name = "L" + str(random.randint(10000, 99999))
        ...
        sponsor = {"account": get_random_name(6, 25), "password": faker.password(),
                   "name": get_random_name(4, 20), "email": faker.email(),
