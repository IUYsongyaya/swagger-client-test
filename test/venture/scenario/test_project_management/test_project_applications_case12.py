...
class TestProjectCase12(object):

    @pytest.mark.order1
    def test_applications12(self):
        faker = Faker()
        ...
        short_name = "S" + str(random.randint(10000, 99999))
        ...
        for item in res.items:
            ...
            audit_project_id = item.id
        # 获取项目申请详情
        res = project_api.applications_id_get(id=audit_project_id)
        assert res.status == 'turn_down'
