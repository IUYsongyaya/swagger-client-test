...
# 申请项目——审核通过——前台获取项目列表——修改项目信息——前台获取项目列表——查看项目详情
...
class TestProjectCase4(object):
    ...
    def test_applications4(self):
        ...
        project_api.projects_id_put(id=audit_project_id, type='base', body=data)
        # 获取项目列表
        res = project_api.projects_get(page=1)
        audit_project_id = ''
        for item in res.items:
