...
class TestProjectCase13(object):

    @pytest.mark.order1
    def test_applications13(self):
        faker = Faker()
        ...
        short_name = "T" + str(random.randint(10000, 99999))
        ...
        for item in res.items:
            ...
            id_ = item.id
        # 后台获取项目详情
        res = staff_project.projects_id_get(id=id_)
