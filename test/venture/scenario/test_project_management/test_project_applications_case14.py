...
class TestProjectCase14(object):

    @pytest.mark.order1
    def test_applications14(self):
        faker = Faker()
        ...
        short_name = "U" + str(random.randint(10000, 99999))
