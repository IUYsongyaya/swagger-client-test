...
# 项目审核通过——>发送项目公告——>获取项目公告列表——>删除项目公告——>获取项目公告列表
...
class TestAnnouncementCase2(object):
    ...
    def test_announcement2(self):
        ...
        short_name = "B" + str(random.randint(10000, 99999))
        ...
        for item in res.items:
            ...
            id_ = item.id
        # 删除公告
        announcement_api.announcements_id_notice_delete(id=id_)
        # 获取项目公告列表
        res = announcement_api.announcements_project_id_get(project_id=audit_project_id)
