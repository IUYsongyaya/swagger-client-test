#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @Time    : 2019/01/07 15:46
# @Author  : ZDK
# @Email    : zhengdengke@wanshare.com

# 收藏列表（交易所）——收藏——收藏列表（交易所）
...
class TestFavoriteProjectCase8(object):
    ...
    def test_favorite_project_case8(self):
        ...
        # 判断是否收藏
        res = favorite_api.favorites_exchange_is_favorite_get(exchange_id=exchange_id)
