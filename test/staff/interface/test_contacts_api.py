...
from swagger_client.staff.api.contacts_api import ContactsApi  # noqa: E501
...
api = swagger_client.staff.api.contacts_api.ContactsApi()
...
class TestContactsApi:
    ...
    def test_contacts_projects_exchange_id_get(self):
