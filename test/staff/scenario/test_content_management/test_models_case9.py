#!/usr/bin/env python
# -*- coding: utf-8 -*-
# @Time    : 2018/11/29 17:10
# @Author  : ZDK
# @Email    : zhengdengke@wanshare.com

# 新建文章kinmall文章模型——获取kinmall文章模型列表——获取kinmall文章模型详情——更新kinmall文章模型信息——获取kinmall文章模型列表——获取kinmall文章模型详情
import pytest
import random
...
class TestModelsCase9(object):

    @pytest.mark.order1
    def test_models_case9(self):
        # 后台登录
