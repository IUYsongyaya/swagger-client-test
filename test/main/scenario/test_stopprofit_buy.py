...
from .profitloss_data import (FIELDS, stopprofit_buy, stopprofit_buy_fail, get_random_price_and_volume)
...
class TestTakeProfitSell:
    @pytest.mark.parametrize(FIELDS, stopprofit_buy)
    def test_stopprofit_buy(self, market_id, price, entrust_type, trade_type,
        ...
        payload.auto_cancel_at = auto_cancel_at
        # login
        entrust_special_login([main_ac_api, main_entrust_api])
        # 1.先下一买一卖,构造最新成交价
    ...
    @pytest.mark.parametrize(FIELDS, stopprofit_buy_fail)
