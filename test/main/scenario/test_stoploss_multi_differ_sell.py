...
from .profitloss_data import FIELDS, stoploss_multi_differ_sell, get_random_price_and_volume
...
class TestFirstBuyMultiDifferentPriceOneSell:
    ...
    @pytest.mark.parametrize(FIELDS, stoploss_multi_differ_sell)
    def test_multi_sell_volume_eq(self, market_id, price, entrust_type, trade_type,
        ...
        time.sleep(5)
        # 4.当前成交价价变动时,当前价小于等于触发价，开始委托,委托价小于卖一时候,,检查委托列表是否有委托订单记录
