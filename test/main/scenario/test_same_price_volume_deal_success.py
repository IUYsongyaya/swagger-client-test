...
from .data import (FIELDS, same_price_volume_entrust_data, get_random_price_and_volume)
...
class TestSamePriceVolumeDealSuccess:
    ...
    def test_same_price_volume_success(self, market_id, price, entrust_type, trade_type,
        ...
        # login
        special_info = special_login([api, main_ac_api, main_quota_api, tenant_quota_api, venture_quota_api])
