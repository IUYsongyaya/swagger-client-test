...
class GetEntrustsResponseItems(object):
    ...
    def __init__(self, order_id=None, created_at=None, exchange_name=None, trade_type=None, entrust_type=None, trading_pair=None, price=None, entrust_volume=None, entrust_amount=None, volume=None, amount=None, status=None, trigger_price=None, auto_cancel_at=None):  # noqa: E501
