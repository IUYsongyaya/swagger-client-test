...
class AccountApi(object):
    ...
    def accounts_profile_get(self, **kwargs):  # noqa: E501
        """获取用户个人资料  # noqa: E501

        获取用户个人资料  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.accounts_profile_get(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.accounts_profile_get_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.accounts_profile_get_with_http_info(**kwargs)  # noqa: E501
            return data

    def accounts_profile_get_with_http_info(self, **kwargs):  # noqa: E501
        """获取用户个人资料  # noqa: E501

        获取用户个人资料  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.accounts_profile_get_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method accounts_profile_get" % key
                )
            params[key] = val
        del params['kwargs']
