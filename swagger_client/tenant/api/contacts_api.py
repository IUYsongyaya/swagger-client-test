...
class ContactsApi(object):
    ...
    def contacts_project_id_status_get(self, project_id, **kwargs):  # noqa: E501
        """获取项目和交易所的状态  # noqa: E501

        获取项目和交易所的状态  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.contacts_project_id_status_get(project_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.contacts_project_id_status_get_with_http_info(project_id, **kwargs)  # noqa: E501
        else:
            (data) = self.contacts_project_id_status_get_with_http_info(project_id, **kwargs)  # noqa: E501
            return data

    def contacts_project_id_status_get_with_http_info(self, project_id, **kwargs):  # noqa: E501
        """获取项目和交易所的状态  # noqa: E501

        获取项目和交易所的状态  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.contacts_project_id_status_get_with_http_info(project_id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method contacts_project_id_status_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'project_id' is set
        if ('project_id' not in params or
                params['project_id'] is None):
            raise ValueError("Missing the required parameter `project_id` when calling `contacts_project_id_status_get`")  # noqa: E501
